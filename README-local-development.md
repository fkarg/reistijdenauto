...
*This document describes how to serve your own datasets using the Datapunt
Amsterdam Mapserver container, which is only declared a dependency in the
docker-compose-file.* This document was copied from the
[Amsterdam/mapserver][mapserver] repository.
...
[mapserver]: https://github.com/Amsterdam/mapserver
